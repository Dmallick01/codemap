    ...
    <div className="flex-none z-30">
      ...
      {showHelp && (
        ...
        >
          ...
          <span>
            <kbd style={{ color: "var(--text-primary)" }}>G</kbd> Prompts
          </span>
          <span>
            <kbd style={{ color: "var(--text-primary)" }}>S</kbd> Security brief
          </span>
          <span>
            <kbd style={{ color: "var(--text-primary)" }}>E</kbd> Export (UI Studio)
          </span>
          <span>
