...
export const MAP_TILE_ROW_GAP = 10;
export const MAP_TILE_ROW_STRIDE = MAP_TILE_HEIGHT + MAP_TILE_ROW_GAP;

export const MAP_GROUP_PAD_X = 24;
export const MAP_GROUP_PAD_Y = 32;
export const MAP_GROUP_PAD_BOTTOM = 28;
export const MAP_GROUP_GAP_Y = 40;

export const MAP_ROLE_STEP_X = 300;
export const MAP_DEPTH_STEP_X = 28;
