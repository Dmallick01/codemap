...
export default function AnalyzePage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-950 text-white overflow-hidden">
      {/* ── Header ── */}
      <header className="flex-none h-12 flex items-center gap-3 px-4 border-b border-gray-800 bg-gray-950/90 backdrop-blur-sm z-20">
        <a
          href="/"
      ...
      <div className="flex-1 relative" style={{ minHeight: 0 }}>
        ...
        {/* Detail sidebar — rendered inside the canvas wrapper so absolute positioning works */}
